...
ifort -O3 -mcmodel=medium makelowcov_combined.f90 -o makelowcov
...
cat out_vcf_lcWGS_2x5x10x | sed 's/\t/ /g' | sed 's/chr//g' | awk '{$1=$1" "$1"_"$2}1' > out_vcf_lcWGS_2x5x10x_gen.txt
